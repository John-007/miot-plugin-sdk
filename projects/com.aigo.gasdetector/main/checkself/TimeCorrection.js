...
export default class CheckSelf extends React.Component {
  ...
  sendTestText() {
    ...
    let MM = this.prefixInteger((date.getMonth() + 1 < 10 ? `0${ date.getMonth() + 1 }` : date.getMonth() + 1).toString(16), 2);
    let DD = this.prefixInteger((date.getDate() < 10 ? `0${ date.getDate() }` : date.getDate()).toString(16), 2);
    let hh = this.prefixInteger((date.getHours() < 10 ? `0${ date.getHours() }` : date.getHours()).toString(16), 2);
    let mm = this.prefixInteger((date.getMinutes() < 10 ? `0${ date.getMinutes() }` : date.getMinutes()).toString(16), 2);
    let ss = this.prefixInteger((date.getSeconds() < 10 ? `0${ date.getSeconds() }` : date.getSeconds()).toString(16), 2);
    ...
    return (
      <View
        ...
        }}>
          {
            this.state.buttonVisible ? (
              <Button
                ...
                title={PluginStrings.timeCorrectionBtnStr}
                color={'#32BAC0'}
                onPress={() => {
                  this.sendTestText();
        ...
        <AbstractDialog
          ...
          title={PluginStrings.timeCorrectionSuccessStr}
          buttons={[
            {
