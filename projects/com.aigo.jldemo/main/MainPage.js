...
import { Easing, Animated, View, Text, Image, StyleSheet, TouchableOpacity, ScrollView } from 'react-native';
    ...
    return (
      <View style={styles.container}>
        ...
        <ScrollView style={{ flex: 1 }}>
          ...
          <View style={{ marginTop: 220, justifyContent: 'center', flexDirection: 'column', alignItems: 'center' }}>
            <Animated.Image style={[styles.circle, { transform: [{ rotate: spin }] }]} source={require('../resources/images/welcome.png')} />
          </View>
